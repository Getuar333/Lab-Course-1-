    ...
    <div className="h-[93.33vh] overflow-hidden flex items-center justify-center bg-gradient-to-br from-blue-100 to-blue-300 px-4">
      <div className="bg-white shadow-lg rounded-xl p-13 w-full max-w-md">
        ...
        <form className="space-y-6">
          ...
          <div>
            <input type="password" className="w-full border border-blue-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Shkruani fjalëkalimin e ri" required/>
          </div>
